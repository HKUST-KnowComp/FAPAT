...
if __name__ == "__main__":    
    ...
    pickle.dump(dict(zip(keys, train)), open("Tmall/train.pkl", "wb"))
    pickle.dump(dict(zip(keys, valid)), open("Tmall/valid.pkl", "wb"))
    pickle.dump(dict(zip(keys, test)), open("Tmall/test.pkl", "wb"))
